-- Migration pour désactiver définitivement toutes les politiques RLS
-- Cette migration s'assure que les politiques RLS sont complètement désactivées
...
AND tablename IN ('profiles', 'repairer_profiles', 'items', 'quotes', 'repairs', 'marketplace_items', 'subscriptions', 'eco_transactions');
